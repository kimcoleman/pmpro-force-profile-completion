...
Force Profile Completion requires members to complete their profile information (any required User Fields) before accessing restricted areas or features of your site, ensuring you collect all necessary user data. Contributions of all kinds are appreciated.
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-force-profile-completion/issues)
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-force-profile-completion.git` to set the upstream repo
